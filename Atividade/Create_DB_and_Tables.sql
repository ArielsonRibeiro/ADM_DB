...
CREATE TABLE [Cursos](
    COD_CURSO   SMALLINT     NOT NULL CHECK (COD_CURSO > 0)
...
CREATE TABLE [Alunos](
    ...
    , CONSTRAINT ALUNOS_CHECK_IDADES CHECK ( FLOOR(  DATEDIFF(DAY,DAT_NASC, GETDATE() )/365.25 )>= 16) --LISTA:Q16
);
GO
